            ...
            $.ajax({
                ...
                success: function(data) {
                    $.each(data, function(i, item) {
                        $( "#myImagesDiv" ).append( '<a href="#" onclick=\'CKEDITOR.dialog.getCurrent().getContentElement("tab-my-img","src").setValue("' + data[i].fields.base + '"); CKEDITOR.dialog.getCurrent().getContentElement("tab-my-img","pk").setValue(' + data[i].pk + '); \'><div style="white-space: normal !important;width:135px;height:135px;display:inline-block;margin-right: 10px;" id="image_' + data[i].pk + '"><img src="/static/' + data[i].fields.thumbnail + '" style="width: 135px;"/><p>' + data[i].fields.title +' </p></div></a>' );
                    });
                },
